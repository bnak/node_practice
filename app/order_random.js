...
function orderRandom10IntegerArray(){
	console.log("2. Write a console app that generates 10 random integers and then outputvthose same arguments in order from lowest to highest.") 
	
	const unsortedArray = generateNRandomIntegers(0, 1000000, 10)  
	console.log(`Ten random integers between 0 and 1,000,000 : ${unsortedArray}`)  
